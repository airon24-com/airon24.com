...
class AdminRbthemesliderSkinController extends ModuleAdminController
{
    ...
    public function setMedia($isNewTheme = false)
    {
        ...
        $GLOBALS['rb_screen'] = (object) array(
          'id' => 'rbthemeslider_page_rb-skin-editor',
          'base' => 'rbthemeslider_page_rb-skin-editor'
        );
        // simulate wp page
        ${'_GET'}['page'] = 'rb-skin-editor';
