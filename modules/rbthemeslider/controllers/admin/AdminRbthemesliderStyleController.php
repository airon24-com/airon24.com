...
class AdminRbthemesliderStyleController extends ModuleAdminController
{
    ...
    public function setMedia($isNewTheme = false)
    {
        ...
        $GLOBALS['rb_screen'] = (object) array(
          'id' => 'rbthemeslider_page_rb-style-editor',
          'base' => 'rbthemeslider_page_rb-style-editor'
        );
        // simulate wp page
        ${'_GET'}['page'] = 'rb-style-editor';
