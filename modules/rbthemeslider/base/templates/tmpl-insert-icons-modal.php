...
<script type="text/html" id="tmpl-insert-icons-modal">
    <div id="rb-insert-icons-modal-window">
        <header>
            <h1><?php rb_e('Insert Icon', 'RbthemeSlider') ?></h1>
            <b class="dashicons dashicons-no"></b>
        </header>
        <div class="km-ui-modal-scrollable">
            <div class="search-holder">
                <input type="search" name="s" placeholder="<?php rb_e('Search icons ...', 'RbthemeSlider') ?>">
            </div>
            <div class="results">


                <!-- Web Application Icons -->
                <h2><?php rb_e('Web Application Icons', 'RbthemeSlider') ?></h2>
                ...
                <!-- Accessibility Icons -->
                <h2><?php rb_e('Accessibility Icons', 'RbthemeSlider') ?></h2>
                <section class="clearfix">
                    <div data-help="american-sign-language-interpreting"><i class="fa fa-american-sign-language-interpreting"></i></div>
                    <div data-help="american-sign-language-interpreting"><i class="fa fa-american-sign-language-interpreting"></i></div>
                    <div data-help="assistive-listening-systems"><i class="fa fa-assistive-listening-systems"></i></div>
                ...
                <!-- Hand Icons -->
                <h2><?php rb_e('Hand Icons', 'RbthemeSlider') ?></h2>
                <section class="clearfix">
                    <div data-help="hand-rock-o"><i class="fa fa-hand-rock-o"></i></div>
                    <div data-help="hand-lizard-o"><i class="fa fa-hand-lizard-o"></i></div>
                ...
                <h2><?php rb_e('Transportation Icons', 'RbthemeSlider') ?></h2>
                <section class="clearfix">
                ...
                <!-- Gender Icons -->
                <h2><?php rb_e('Gender Icons', 'RbthemeSlider') ?></h2>
                <section class="clearfix">
                ...
                <!-- File Type Icons -->
                <h2><?php rb_e('File Type Icons', 'RbthemeSlider') ?></h2>
                <section class="clearfix">
                ...
                <!-- File Type Icons -->
                <h2><?php rb_e('Spinner Icons', 'RbthemeSlider') ?></h2>
                <section class="clearfix">
                    <div data-help="circle-o-notch"><i class="fa fa-circle-o-notch"></i></div>
                    <div data-help="cog"><i class="fa fa-cog"></i></div>
                    <div data-help="cog"><i class="fa fa-cog"></i></div>
                ...
                <!-- Form Control Icons -->
                <h2><?php rb_e('Form Control Icons', 'RbthemeSlider') ?></h2>
                <section class="clearfix">
                    <div data-help="check-square"><i class="fa fa-check-square"></i></div>
                    <div data-help="check-square-o"><i class="fa fa-check-square-o"></i></div>
                    <div data-help="circle"><i class="fa fa-circle"></i></div>
                ...
                <!-- Payment Icons -->
                <h2><?php rb_e('Payment Icons', 'RbthemeSlider') ?></h2>
                <section class="clearfix">
                ...
                <!-- Chart Icons -->
                <h2><?php rb_e('Chart Icons', 'RbthemeSlider') ?></h2>
                <section class="clearfix">
                    <div data-help="area-chart"><i class="fa fa-area-chart"></i></div>
                    <div data-help="bar-chart"><i class="fa fa-bar-chart"></i></div>
                    <div data-help="bar-chart"><i class="fa fa-bar-chart"></i></div>
                ...
                <!-- Currency Icons -->
                <h2><?php rb_e('Currency Icons', 'RbthemeSlider') ?></h2>
                <section class="clearfix">
                ...
                <!-- Text Editor Icons -->
                <h2><?php rb_e('Text Editor Icons', 'RbthemeSlider') ?></h2>
                <section class="clearfix">
                ...
                <!-- Directional Icons -->
                <h2><?php rb_e('Directional Icons', 'RbthemeSlider') ?></h2>
                <section class="clearfix">
                ...
                <!-- Video Player Icons -->
                <h2><?php rb_e('Video Player Icons', 'RbthemeSlider') ?></h2>
                <section class="clearfix">
                    <div data-help="arrows-alt"><i class="fa fa-arrows-alt"></i></div>
                ...
                <!-- Brand Icons -->
                <h2><?php rb_e('Brand Icons', 'RbthemeSlider') ?></h2>
                <section class="clearfix">
                ...
                <!-- Medical Icons -->
                <h2><?php rb_e('Medical Icons', 'RbthemeSlider') ?></h2>
                <section class="clearfix">
                    <div data-help="ambulance"><i class="fa fa-ambulance"></i></div>
