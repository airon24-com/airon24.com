	...
	window.kmUI  = {
		...
		notify: {
			...
			show: function( settings ) {
				...
				var $notification     = $('.rb-notify-osd'),
			...
			hide: function() {
				...
				$('.rb-notify-osd').removeClass('visible');
			}
		},
			...
			open : function( el, po ) {
				...
				setTimeout( function(){
					...
					if( po ){
						...
						$popover.find( '.km-ui-popover-inner' ).html( $el.siblings( '.rb-popover-data, .km-ui-popover-data' ).html() );
