...
class Rbthemedream extends Module
{
    ...
    {
        $content = Tools::file_get_contents(_PS_MODULE_DIR_. 'rbthemedream/views/css/core.css');
    ...
    {
        $content = "";
        $rbthemesliders = Db::getInstance()->executeS('SELECT * FROM `'._DB_PREFIX_.'rbthemeslider`');

        if (!empty($rbthemesliders)) {
            $content .= 'INSERT INTO `PREFIXrbthemeslider`(`id`,`author`,`name`,`slug`,`data`,`date_c`,`date_m`,`schedule_start`,`schedule_end`,`flag_hidden`,`flag_deleted`) VALUES ';
            $count = 1;

            foreach ($rbthemesliders as $rbthemeslider) {
                if ($count == 1) {
                    $content .= "('".$rbthemeslider['id']."','".$rbthemeslider['author']."','".$rbthemeslider['name']."','".$rbthemeslider['slug']."','".$rbthemeslider['data']."','".$rbthemeslider['date_c']."','".$rbthemeslider['date_m']."','".$rbthemeslider['schedule_start']."','".$rbthemeslider['schedule_end']."','".$rbthemeslider['flag_hidden']."','".$rbthemeslider['flag_deleted']."')";
                } else {
                    $content .= ",('".$rbthemeslider['id']."','".$rbthemeslider['author']."','".$rbthemeslider['name']."','".$rbthemeslider['slug']."','".$rbthemeslider['data']."','".$rbthemeslider['date_c']."','".$rbthemeslider['date_m']."','".$rbthemeslider['schedule_start']."','".$rbthemeslider['schedule_end']."','".$rbthemeslider['flag_hidden']."','".$rbthemeslider['flag_deleted']."')";;
                }
        ...
        $rbthemeslider_modules = Db::getInstance()->executeS('SELECT * FROM `'._DB_PREFIX_.'rbthemeslider_module`');

        if (!empty($rbthemeslider_modules)) {
            $content .= 'INSERT INTO `PREFIXrbthemeslider_module`(`id_slider`,`id_shop`,`id_lang`,`hook`,`position`,`pages`) VALUES ';
            $count = 1;

            foreach ($rbthemeslider_modules as $rbthemeslider_module) {
                if ($count == 1) {
                    $content .= "('".$rbthemeslider_module['id_slider']."','".$rbthemeslider_module['id_shop']."','".$rbthemeslider_module['id_lang']."','".$rbthemeslider_module['hook']."','".$rbthemeslider_module['position']."','".$rbthemeslider_module['pages']."')";
                } else {
                    $content .= ",('".$rbthemeslider_module['id_slider']."','".$rbthemeslider_module['id_shop']."','".$rbthemeslider_module['id_lang']."','".$rbthemeslider_module['hook']."','".$rbthemeslider_module['position']."','".$rbthemeslider_module['pages']."')";
                }
        ...
        $rbthemeslider_revisions = Db::getInstance()->executeS('SELECT * FROM `'._DB_PREFIX_.'rbthemeslider_revisions`');

        if (!empty($rbthemeslider_revisions)) {
            $content .= 'INSERT INTO `PREFIXrbthemeslider_revisions`(`id`,`slider_id`,`author`,`data`,`date_c`) VALUES ';
            $count = 1;

            foreach ($rbthemeslider_revisions as $rbthemeslider_revision) {
                if ($count == 1) {
                    $content .= "('".$rbthemeslider_revision['id']."','".$rbthemeslider_revision['slider_id']."','".$rbthemeslider_revision['author']."','".$rbthemeslider_revision['data']."','".$rbthemeslider_revision['date_c']."')";
                } else {
                    $content .= ",('".$rbthemeslider_revision['id']."','".$rbthemeslider_revision['slider_id']."','".$rbthemeslider_revision['author']."','".$rbthemeslider_revision['data']."','".$rbthemeslider_revision['date_c']."')";
                }
    ...
    public function hookHeader()
    {
        ...
        $this->context->controller->addJS($this->_path.'views/js/plugin/rb-numerator.js');
        $this->context->controller->addJS($this->_path.'views/js/plugin/rb-nprogress.js');
        $this->context->controller->addJS($this->_path.'views/js/plugin/rb-slick.js');
        $this->context->controller->addJS($this->_path.'views/js/plugin/rb-img-360.js');
        $this->context->controller->addJS($this->_path.'views/js/plugin/rb-prism.js');
        ...
        $this->context->controller->addCSS($this->_path.'views/css/lib/rb-img-360.css');
        $this->context->controller->addCSS($this->_path.'views/css/lib/rb-prism.css');
