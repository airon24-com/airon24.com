...
class RbTpl extends RbControl
{
    ...
    public function rbRender($instance = array())
    {
        ...
        if (isset($optionsSource['file'])){
            ...
            if (file_exists($this->module->getLocalPath() . 'views/templates/widget/custom/'.$optionsSource['file'].'.tpl')) {
                return $module->fetch('module:rbthemedream/views/templates/widget/custom/'.$optionsSource['file'].'.tpl');
            } else {
                return;
            }
        }
