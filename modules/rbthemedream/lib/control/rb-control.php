...
class RbControl
{
    ...
    {
        if (Tools::strrpos($image, 'localhost') !== false) {
            $new_url = strstr($image, 'img/cms/');

            return $this->context->shop->getBaseURL(true, true) . $new_url;
        }
    ...
    public function totalProductByIDCategory($id_category)
    {
