...
class Rbthemefunction extends Module
{
    ...
    public function rbRegisterHook()
    {
        ...
        $this->registerHook('displayRbMostSearch');
    ...
    protected function getConfigForm()
    {
        ...
        $fields_form[0]['form'] = array(
            'input' => array(
                ...
                array(
                    'type' => 'switch',
                    'label' => $this->l('Show/Hide Most Searched'),
                    'name' => 'RBTHEMEFUNCTION_MOST_SEARCHED',
                    'is_bool' => true,
                    'desc' => $this->l('Show/Hide Most Searched'),
                    'values' => $switch
                ),
            ),
            'submit' => array(
        ...
        $fields_form[5]['form'] = array(
            'input' => array(
                array(
                    'type' => 'switch',
                    'label' => $this->l('Display facebook timeline'),
                    'name' => 'RBTHEMEFUNCTION_FACEBOOK_TIMELINE',
                    'is_bool' => true,
                    'values' => $switch
                ),
                array(
                    'type' => 'text',
                    'label' => $this->l('Width'),
                    'name' => 'RBTHEMEFUNCTION_FACEBOOK_TIMELINE_W',
                    'desc' => '500',
                    'col' => 3
                ),
                array(
                    'type' => 'text',
                    'label' => $this->l('Height'),
                    'name' => 'RBTHEMEFUNCTION_FACEBOOK_TIMELINE_H',
                    'desc' => '500',
                    'col' => 3
                ),
                array(
                    'type' => 'text',
                    'label' => $this->l('Link page'),
                    'name' => 'RBTHEMEFUNCTION_FACEBOOK_TIMELINE_URL',
                    'desc' => 'https://www.facebook.com',
                    'col' => 3
                ),
                array(
                    'type' => 'text',
                    'label' => $this->l('Name page'),
                    'name' => 'RBTHEMEFUNCTION_FACEBOOK_TIMELINE_NAME',
                    'desc' => 'Prestashop',
                    'col' => 3
                ),
            ),
        ...
        $fields_form[6]['form'] = array(
            'input' => array(
                array(
                    'type' => 'switch',
                    'label' => $this->l('Display facebook timeline'),
                    'name' => 'RBTHEMEFUNCTION_TWITTER_TIMELINE',
                    'is_bool' => true,
                    'values' => $switch
                ),
                array(
                    'type' => 'textarea',
                    'label' => $this->l('Code display twitter'),
                    'name' => 'RBTHEMEFUNCTION_TWITTER_CODE',
                    'lang' => false,
                    'desc' => 'Link get code: ' . '<a target="_blank" href="https://publish.twitter.com">https://publish.twitter.com</a>',
                ),
            ),
            'submit' => array(
                'title' => $this->l('Save'),
    ...
    protected function getConfigFormValues()
    {
        ...
        return array(
            ...
            'RBTHEMEFUNCTION_MOST_SEARCHED' => Configuration::get('RBTHEMEFUNCTION_MOST_SEARCHED'),

            /**********************Config facebook timeline****************************/
            'RBTHEMEFUNCTION_FACEBOOK_TIMELINE' => Configuration::get('RBTHEMEFUNCTION_FACEBOOK_TIMELINE'),
            'RBTHEMEFUNCTION_FACEBOOK_TIMELINE_W' => Configuration::get('RBTHEMEFUNCTION_FACEBOOK_TIMELINE_W'),
            'RBTHEMEFUNCTION_FACEBOOK_TIMELINE_H' => Configuration::get('RBTHEMEFUNCTION_FACEBOOK_TIMELINE_H'),
            'RBTHEMEFUNCTION_FACEBOOK_TIMELINE_URL' => Configuration::get('RBTHEMEFUNCTION_FACEBOOK_TIMELINE_URL'),
            'RBTHEMEFUNCTION_FACEBOOK_TIMELINE_NAME' => Configuration::get('RBTHEMEFUNCTION_FACEBOOK_TIMELINE_NAME'),
            /*********************End Config facebook timeline*****************************/

            /**********************Config twitter timeline****************************/
            'RBTHEMEFUNCTION_TWITTER_TIMELINE' => Configuration::get('RBTHEMEFUNCTION_TWITTER_TIMELINE'),
            'RBTHEMEFUNCTION_TWITTER_CODE' => Tools::htmlentitiesDecodeUTF8(Configuration::get('RBTHEMEFUNCTION_TWITTER_CODE')),
            /**********************End Config twitter timeline****************************/
        );
    }
    ...
    protected function postProcess()
    {
        ...
        if (Tools::getValue('RBTHEMEFUNCTION_FACEBOOK_TIMELINE') == 1) {
            $this->registerHook('displayRbFacebookTimeline');
        } else {
            $this->unregisterHook('displayRbFacebookTimeline');
        }

        if (Tools::getValue('RBTHEMEFUNCTION_TWITTER_TIMELINE') == 1) {
            $this->registerHook('displayRbTwitterTimeline');
        } else {
            $this->unregisterHook('displayRbTwitterTimeline');
        }
        ...
        foreach (array_keys($form_values) as $key) {
            ...
            } else if ($key == 'RBTHEMEFUNCTION_TWITTER_CODE') {
                Configuration::updateValue('RBTHEMEFUNCTION_TWITTER_CODE', Tools::safeOutput(Tools::getValue('RBTHEMEFUNCTION_TWITTER_CODE'), true));
            } else {
    ...
    public function hookdisplayRbFacebookTimeline($params)
    {
        $this->smarty->assign(array(
            'lang_fb' => str_replace('-', '_', $this->context->language->locale),
            'url_fb' => Configuration::get('RBTHEMEFUNCTION_FACEBOOK_TIMELINE_URL'),
            'name_fb' => Configuration::get('RBTHEMEFUNCTION_FACEBOOK_TIMELINE_NAME'),
            'width_fb' => Configuration::get('RBTHEMEFUNCTION_FACEBOOK_TIMELINE_W'),
            'height_fb' => Configuration::get('RBTHEMEFUNCTION_FACEBOOK_TIMELINE_H'),
        ));

        return $this->display(__FILE__, 'views/templates/hook/rb-facebook.tpl');
    }

    public function hookdisplayRbTwitterTimeline($params)
    {
        $this->smarty->assign(array(
            'code_tt' => Tools::htmlentitiesDecodeUTF8(Configuration::get('RBTHEMEFUNCTION_TWITTER_CODE')),
        ));

        return $this->display(__FILE__, 'views/templates/hook/rb-twitter.tpl');
    }

    public function hookdisplayRbMostSearch($params)
    {
        if (Configuration::get('RBTHEMEFUNCTION_MOST_SEARCHED') != 1 ||
            !Module::isInstalled('statssearch')
        ) {
            return;
        }
        ...
        $this->smarty->assign(array(
            'statssearch' => Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS($sql),
        ));

        return $this->display(__FILE__, 'views/templates/hook/rb-mostsearch.tpl');
    }
