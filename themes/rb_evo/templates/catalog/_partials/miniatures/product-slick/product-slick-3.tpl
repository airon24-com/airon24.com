...
* @author PrestaShop SA <contact@prestashop.com>
  ...
  *}
  ...
  <div class="product-style3" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
    {if isset($position)}
    ...
    <article
      ...
      <div class="thumbnail-container">
        <div class="product-image">
          ...
          <div class="product-attribute highlighted-informations{if !$product.main_variants} no-variants{/if} hidden-sm-down">
