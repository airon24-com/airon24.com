      ...
      <div class="thumbnail-container">
        <div class="product-image">
          ...
          <a href="{$product.url}" class="thumbnail product-thumbnail">
            <img class="img-fluid rb-image image-cover" data-lazy="{$product.cover.bySize.home_default.url}"
            ...
            <div class="product-hover">
              <img class="img-fluid rb-image image-hover" data-lazy="{$image.bySize.home_default.url}"
                title="{$product.name|truncate:30:'...'}" width="{$image.bySize.home_default.width}"
