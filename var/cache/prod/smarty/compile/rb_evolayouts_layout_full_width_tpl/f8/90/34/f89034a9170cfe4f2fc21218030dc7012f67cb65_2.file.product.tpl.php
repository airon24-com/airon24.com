...
" id="product_customization_id" class="js-product-customization-id">
        ...
        <div class="m-accordion is-variation-1 mt-10">
          ...
          <div id="accordion-1" class="m-accordion-contents">
            <div class="fs-14px text-left mb-5 mt-5">
              <p>W skład poniższych cen wchodzi wybrany klimatyzator&nbsp;z <strong>usługą montażu&nbsp;podstawowego.</strong> Termin montażu do 14 dni.&nbsp;Skontaktujemy się do 48 godzin po złożeniu zamówienia w celu ustalenia dogodnego terminu.</p>
              ...
              <div class="col-6">
                <div class="m-checkable-tile">
                  ...
                  <label for="extraServiceForm-1_2" class="m-checkable-tile-inner-box">
                    ...
                    <div class="fs-12px gray-3 text-left mt-5">
                      <p>klimatyzator z&nbsp;montażem&nbsp;dla konsumenta (8% VAT)</p>
                    </div>
                  </label>
                </div>
              </div>
              <div class="col-6">
                <div class="m-checkable-tile">
                  ...
                  <label for="extraServiceForm-1_3" class="m-checkable-tile-inner-box">
                    ...
                    <div class="fs-12px gray-3 text-left mt-5">
                      <p>klimatyzator&nbsp;z montażem&nbsp;dla firmy (23% VAT)</p>
                    </div>
                  </label>
                </div>
              </div>
