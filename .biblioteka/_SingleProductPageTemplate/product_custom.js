...
(function ($) {
    ...
    PUS.mousecursor = function () {
        if ($("body")) {
            ...
            }, $("body").on("mouseenter", "img, .fea-box, a, .cursor-pointer", function () {
                e.classList.add("cursor-hover"), t.classList.add("cursor-hover")
            }), $("body").on("mouseleave", "img, .fea-box, a, .cursor-pointer", function () {
